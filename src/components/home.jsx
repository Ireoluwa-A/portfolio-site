    ...
    return (
        <div name='home' className='w-full h-screen bg-[#ece8e3]'>
            ...
            <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full '>
                ...
                <h1 className='absolute left-[29%] top-[35%] text-8xl tracking-wider sm:txt-7xl font-bold text-[] animate-fade_in_left'>
                    IRE
                </h1>
                <h1 className='absolute left-[27.5%] top-[47%] text-8xl tracking-wider sm:txt-7xl font-bold text-[] animate-fade_in_left'>
                    ALARAPE
                </h1>
