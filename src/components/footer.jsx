        ...
        <footer name='footer' className='footer_container'>
            ...
            >
                <div className={`swatch top_swatch ${swatch1Animated ? 'swatch_animated': ''}`}>
                   ...
                   <p className='text-white font-Lato text-[15px]'>Contact me!</p>

                </div>
                <div className='swatch hidden_swatch'>
                    <div className='circle'></div>
                    {/* <div> */}
                        <p className='text-white font-Lato text-[15px]'>Irealarape@gmail.com</p>
                    {/* </div> */}
            ...
            >
                <div className={`swatch top_swatch ${swatch2Animated ? 'swatch_animated': ''}`}>
                    <div className='circle'></div>
                   <p className='text-white font-Lato text-[15px]'>Built from scratch in React</p>
                ...
                <div className='swatch hidden_swatch flex-row'>
                    ...
                    {/* <div> */}  
                        ...
                        <p className='text-white mr-[50px] font-Lato text-[15px] text-left flex '><FaRegCopyright className='text-white mt-[5px] mr-[5px]'></FaRegCopyright>  Ire Alarape 2022</p>
                    {/* </div> */}
